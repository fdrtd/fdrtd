...
def create(accumulator_name):
    ...
    if accumulator_name == 'BasicMinMax':
        from fdrtd.builtins.simon.accumulators.accumulator_basic_minimum_maximum import AccumulatorBasicMinimumMaximum
        return AccumulatorBasicMinimumMaximum

    if accumulator_name == 'BasicSum':
        from fdrtd.builtins.simon.accumulators.accumulator_basic_sum import AccumulatorBasicSum
        return AccumulatorBasicSum

    if accumulator_name == 'SetIntersection':
        from fdrtd.builtins.simon.accumulators.accumulator_set_intersection import AccumulatorSetIntersection
        return AccumulatorSetIntersection

    if accumulator_name == 'SetIntersectionSize':
        from fdrtd.builtins.simon.accumulators.accumulator_set_intersection_size import AccumulatorSetIntersectionSize
